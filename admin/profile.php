...
<div class="container">
  ...
  <img src="../images/user.png" class="card-img-top" height="200" width="100" alt="...">
  <div class="card-body">
    <h3 class="card-title" text-primary>Registered Users</h3>
    
    <a href="registered_users.php" class="btn btn-primary" style="width:100%;">View Users</a>
  </div>
  </div>
  ...
  <div class="card-body">
    ...
    <a href="remove_books.php" class="btn btn-primary" style="width:100%;">Remove Books</a>
  </div>
  </div>
